...
class MealDetailResponse {
  @JsonKey(name: 'meals')
  List<MealDetailModel>? mealsDetail;



  MealDetailResponse({this.mealsDetail});
...
class MealDetailModel {
  ...
  factory MealDetailModel.fromJson(Map<String, dynamic> json) => _$MealDetailModelFromJson(json);
